...
public class PedestalRecipeCategory implements IRecipeCategory<PedestalRecipe> {
    ...
    public static final ResourceLocation SLASH_TEXTURE = ResourceLocation.fromNamespaceAndPath(MusicBoxMod.MODID,"textures/gui/jei/pedestal_slash_icon.png");
    ...
    private final RecipeConditionIcon notConsumed;
    ...
    public PedestalRecipeCategory(IGuiHelper helper) {
        ...
        this.consumeX = new RecipeConditionIcon(helper.createDrawable(X_TEXTURE, 0, 0, 7, 7),
                17, 29, "jeitooltip.musicbox.consumed");
        this.notConsumed = new RecipeConditionIcon(helper.createDrawable(SLASH_TEXTURE, 0, 0, 8, 7),
                16, 29, "jeitooltip.musicbox.not_consumed");
    }
    ...
    public void draw(PedestalRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        if (recipe.consume()) {
            ...
            notConsumed.draw(guiGraphics);
            notConsumed.tryRenderTooltip(guiGraphics, mouseX, mouseY);
        }
    }
}
