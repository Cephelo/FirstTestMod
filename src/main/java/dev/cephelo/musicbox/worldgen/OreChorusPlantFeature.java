...
// This is literally just OreFeature and ChorusPlantFeature combined
public class OreChorusPlantFeature extends Feature<OreConfiguration> {
    public OreChorusPlantFeature(Codec<OreConfiguration> codec) {
        super(codec);
    }
    ...
    public boolean place(FeaturePlaceContext<OreConfiguration> context) {
        ...
        BlockPos plantBlockPos = context.origin();
        RandomSource randomsource = context.random();

        if (worldgenlevel.isEmptyBlock(plantBlockPos) && worldgenlevel.getBlockState(plantBlockPos.below()).is(Blocks.END_STONE)) {
            ChorusFlowerBlock.generatePlant(worldgenlevel, plantBlockPos, randomsource, 8);
            //return true;
        } else return false;

        // OreFeature
        //RandomSource randomsource = context.random();
        BlockPos blockpos = plantBlockPos.below(2);
        //WorldGenLevel worldgenlevel = context.level();
